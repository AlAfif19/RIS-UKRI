    ...
    public function callback(Request $request)
    {
        ...
        if (! $response->successful()) {
            ...
            report(new \RuntimeException(
                'SSO token exchange gagal: ' . $response->body()
            ));

            return redirect('/login')
                ->with(
                    'error',
                    'Gagal terhubung ke SSO, silakan coba lagi.'
                );
        }
        ...
        /**
         * TODO: sesuaikan daftar role di bawah dengan role yang
         * sebenarnya dipakai di RIS/SIKEMAH (Spatie roles).
         */
        if (
